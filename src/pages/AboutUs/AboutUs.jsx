      ...
      <Container className="contAbout">
        ...
        <Row className="backgrCol">
          <Col xs={12} md={6} className="bacgrCol mb-4">
            Bienvenido a <strong>ConcertToYou</strong>, el destino definitivo para los amantes de
            la música en busca de emocionantes experiencias musicales en vivo.
            En <strong>ConcertToYou</strong>, nos apasiona la música y estamos comprometidos a
            proporcionar una plataforma que conecte a músicos jóvenes y locales
            con su audiencia.
          </Col>
          ...
          <Col xs={12} md={6} className="bacgrCol mb-4">
            Descubre Nuevos Talentos: En <strong>ConcertToYou</strong>, creemos en el
            poder de apoyar a músicos emergentes. A través de nuestras funciones
            de promoción, damos visibilidad a talentos locales y jóvenes,
            brindándoles la oportunidad de hacerse un nombre en la escena
            musical.
          </Col>
        </Row>
